...
2. service.beta.kubernetes.io/qingcloud-load-balancer-eip-ids，负载均衡器上绑定的 eip id，最多支持4个，这个 annotation 表示要创建的是 “公网” 类型的负载均衡器。
...
2. 由于需要从 dockerhub.qingcloud.com 下载镜像，请确保集群所在私网能够访问公网。（vpc绑定了公网ip)
3. 更多 Kubernetes 的使用方法请参考 [ Kubernetes 官方文档](https://kubernetes.io/docs/home/)
