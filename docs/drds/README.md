...
![节点设置](../../images/drds/base_step_4.png)
...
![写入查询](../../images/drds/write_monitor.png)

![行锁定](../../images/drds/lock_monitor.png)

![CPU利用率](../../images/drds/cpu_monitor.png)
